...
//   }
  ...
  return (
    ...
    <form className="w-full flex flex-col space-x-4 md:">
    <input onChange={(e)=>setTitle(e.target.value) }type="text"  placeholder="enter your post title" className="px-4 py-2 outline-none"/>
    <input onChange={(e)=>setPhoto(e.target.value) }type="text"  placeholder="enter your post photo" className="px-4 py-2 outline-none"/>
